...
use App\Http\Controllers\Api\AdMediaController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('ads/all-exchange', [AdController::class, 'allExchange']);
    ...
    Route::post('update-ad/{id}', [AdController::class, 'update']);
    Route::post('service-ads/{id}/media', [AdMediaController::class, 'store']);
    Route::delete('service-ads/media/{id}', [AdMediaController::class, 'destroy']);
